...
public class OdoDriveMode extends LinearOpMode{
    ...
    private void resetLift() {robot.lift.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    }

    private double[] calcPower(double x, double y, double[] currPos){
